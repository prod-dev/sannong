 ...
 */
define('searchwizard', ['jquery', 'travel', "bootstrap", "bootstrap-datepicker"], function ($, Travel, Bootstrap, BootstrapDatePicker) {
    ...
    Searchwizard.getBusFromCity = function(){
    ...
    Travel.Searchwizard = Searchwizard;
    return Searchwizard;
});
