...
define(['jquery', 'bootstrap', 'handlebars', 'sannong', 'validate', 'ajaxHandler', 'formValidator',
        'additionalMethods', 'pagination', 'selector', 'jqueryForm', 'userProfile', 'eventHandler'],
                    ...
                    ajaxHandler.sendRequest({
                        ...
                        success: function(response){
                            if (response.statusCode < 2000){
                                ...
                                // TODO: As user-profile template was re-generated by Handlebars JS, we have to re-bind the events.
